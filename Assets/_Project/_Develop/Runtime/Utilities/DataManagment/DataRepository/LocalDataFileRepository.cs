...
namespace Assets.Project._Develop.Runtime.Utilities.DataManagment.DataRepository
{
    public class LocalDataFileRepository : IDataRepository
    {
        private readonly string _folderPath;
        private readonly string _saveFileExtension;

        public LocalDataFileRepository(string folderPath, string saveFileExtension)
        {
